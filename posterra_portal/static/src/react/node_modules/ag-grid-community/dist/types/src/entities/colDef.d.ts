...
export type SortComparatorFn<TData = any, TValue = any> = (valueA: TValue | null | undefined, valueB: TValue | null | undefined, nodeA: IRowNode<TData>, nodeB: IRowNode<TData>, isDescending: boolean) => number;
...
export type ColTypeDefs<TData = any, TValue = any> = {
    [key: string]: ColTypeDef<TData, TValue>;
};
...
export type DndSourceOnRowDragFunc<TData = any, TContext = any> = (params: DndSourceOnRowDragParams<TData, TContext>) => void;
...
export type GetQuickFilterText<TData = any, TValue = any, TContext = any> = (params: GetQuickFilterTextParams<TData, TValue, TContext>) => string;
...
export type SpanRowsFunc<TData = any, TValue = any, TContext = any> = (params: SpanRowsParams<TData, TValue, TContext>) => boolean;
...
export type HeaderTooltipValueGetterFunc<TData = any, TValue = any, TContext = any> = (params: ITooltipParams<TData, TValue, TContext>) => string | any;
export type TooltipValueGetterFunc<TData = any, TValue = any, TContext = any> = (params: ITooltipParams<TData, TValue, TContext>) => string | any;
...
export type EqualsFunc<TValue = any> = (valueA: TValue | null | undefined, valueB: TValue | null | undefined) => boolean;
export type KeyCreatorFunc<TData = any, TValue = any, TContext = any> = (params: KeyCreatorParams<TData, TValue, TContext>) => string;
export interface KeyCreatorParams<TData = any, TValue = any, TContext = any> extends BaseColDefParams<TData, TValue, TContext> {
    /** Value for the cell. */
    value: TValue | null | undefined;
}
export type ColSpanFunc<TData = any, TValue = any, TContext = any> = (params: ColSpanParams<TData, TValue, TContext>) => number;
...
export type RowSpanFunc<TData = any, TValue = any, TContext = any> = (params: RowSpanParams<TData, TValue, TContext>) => number;
...
export type SuppressKeyboardEventFunc<TData = any, TValue = any, TContext = any> = (params: SuppressKeyboardEventParams<TData, TValue, TContext>) => boolean;
export type SuppressHeaderKeyboardEventFunc<TData = any, TValue = any, TContext = any> = (params: SuppressHeaderKeyboardEventParams<TData, TValue, TContext>) => boolean;
...
export type GroupHierarchyConfig = {
    [k: string]: ColDef;
};
export type RefData = {
    [p: string]: any;
