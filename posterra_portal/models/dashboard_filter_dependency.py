...
class DashboardFilterDependency(models.Model):
    ...
    # FilterBar.jsx) acts as the circuit breaker, preventing infinite
    # loops regardless of graph shape. Self-loop and same-page checks
    # above remain as the only structural constraints.
