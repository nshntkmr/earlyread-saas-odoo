...
MAP_FLAGS = [
    ...
    # ── Search & discovery flags ──
    {
        ...
        'help': 'Show the search input for finding locations and entities on the map.',
    },
    {
        'flag': 'search_columns',
        'type': 'text',
        ...
        'help': 'Comma-separated SQL columns that users can search (e.g., hha_name,hha_brand_name,hha_state,hha_county,hha_city,hha_ccn).',
    },
    {
        'flag': 'show_radius_selector',
        'type': 'boolean',
        'default': True,
        'label': 'Show Radius Selector',
        'help': 'Show radius distance pills (10/25/50/100 mi) for proximity search.',
    },
    {
        'flag': 'radius_options',
        'type': 'text',
        'default': '10,25,50,100',
        'label': 'Radius Options (miles)',
        'help': 'Comma-separated distance options for the radius selector.',
    },
    {
        'flag': 'show_status_bar',
        'type': 'boolean',
        'default': True,
        'label': 'Show Status Bar',
        'help': 'Show the bottom status bar with entity counts and active filters.',
    },
    {
        'flag': 'legend_metric_column',
        'type': 'text',
        'default': '',
        'label': 'Legend Metric Column',
        'help': 'Numeric column shown in legend entries (e.g., hha_admits). Users see the aggregated value per category.',
    },
]
