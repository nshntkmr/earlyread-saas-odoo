...
export default function LivePreview({
  ...
  const runPreview = async () => {
    ...
    try {
      ...
      // Formatter errors (e.g. record_header multi-row) come back as {error}
      // at HTTP 200 — promote centrally to the error panel.
  ...
  return (
    <div>
      ...
      {/* Record Header preview — matches the portal RecordHeader. */}
      {isRecordHeader && previewData && !previewData.empty && (
