...
import type { CsvExportParams, ProcessCellForClipboard, ProcessCellFromClipboard, ProcessGroupHeaderForClipboard, ProcessHeaderForClipboard } from '../interfaces/exportParams';
...
export type IsRowFilterable<TData = any, TContext = any> = (params: GetGroupAggFilteringParams<TData, TContext>) => boolean;
export type UseGroupFooter<TData = any, TContext = any> = (params: GetGroupIncludeFooterParams<TData, TContext>) => boolean;
export type UseGroupTotalRow<TData = any, TContext = any> = (params: GetGroupIncludeTotalRowParams<TData, TContext>) => 'top' | 'bottom' | undefined;
export type IsApplyServerSideTransaction<TData = any, TContext = any> = (params: IsApplyServerSideTransactionParams<TData, TContext>) => boolean;
...
export type GetRowStyle<TData = any, TContext = any> = (params: RowClassParams<TData, TContext>) => RowStyle | undefined;
export type GetRowClass<TData = any, TContext = any> = (params: RowClassParams<TData, TContext>) => string | string[] | undefined;
...
export type GetContextMenuItems<TData = any, TContext = any> = (params: GetContextMenuItemsParams<TData, TContext>) => MenuCallbackReturn<DefaultMenuItem, TData, TContext> | Promise<MenuCallbackReturn<DefaultMenuItem, TData, TContext>>;
export type GetFullRowEditValidationErrors = (params: FullRowEditValidationParams) => string[] | null;
export type GetChartToolbarItems<TData = any, TContext = any> = (params: GetChartToolbarItemsParams<TData, TContext>) => ChartToolbarMenuItemOptions[];
export type GetMainMenuItems<TData = any, TContext = any> = (params: GetMainMenuItemsParams<TData, TContext>) => MenuCallbackReturn<DefaultMenuItem, TData, TContext>;
export type GetChartMenuItems<TData = any, TContext = any> = (params: GetChartMenuItemsParams<TData, TContext>) => MenuCallbackReturn<DefaultChartMenuItem, TData, TContext>;
...
export type LoadingCellRendererSelectorFunc<TData = any, TValue = any, TContext = any> = (params: ILoadingCellRendererParams<TData, TValue, TContext>) => LoadingCellRendererSelectorResult | undefined;
